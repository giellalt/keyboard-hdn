.. -*- mode: rst -*-
==========================================
 Keyboards for the Northern Haida language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Northern Haida language. The data and implementations
...
* http://giellatekno.uit.no/hdndoc/index.html
* https://giellalt.uit.no/tools/docu-hdn-manual.html
...
The Northern Haida keyboard sources can be acquired using the `Giella SVN
